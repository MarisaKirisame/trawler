...
impl Sampler {
    fn new(scale: f64) -> Self {
        ...
        Sampler {
            votes_per_user: histogram_sampler::Sampler::from_bins(votes_per_user, 100 * scale),
            votes_per_story: histogram_sampler::Sampler::from_bins(votes_per_story, 10 * scale),
            votes_per_comment: histogram_sampler::Sampler::from_bins(votes_per_comment, 10 * scale),
            comments_per_story: histogram_sampler::Sampler::from_bins(comments_per_story, 10 * scale),
        }
    }
